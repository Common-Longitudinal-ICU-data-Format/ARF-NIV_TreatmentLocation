...
icd_count_table(broad_cohort, "broad")
...
create_tab_3_4 <- function(df, cohort_prefix, tab_num){
  ...
  tab_3_4_continuous <- cbind(summarize_continuous(df, "los_penalized", "los", T),
                         summarize_continuous(df, "days_off", "days_off"))
  ...
  # Create single table for all variables
  tab_3_4_catagorical <- cbind(summarize_categorical(df, "death_hospice", nickname = "dh", include_titles = TRUE),
                          summarize_categorical(df, "death_hospice_28", nickname = "dh_28"),
                          summarize_categorical(df, "death_hospice_60", nickname = "dh_60"),
                          summarize_categorical(df, "imv", nickname = "imv"),
                          summarize_categorical(df, "was_escalated", nickname = "was_escalated"))
  # Output continuous to csv
