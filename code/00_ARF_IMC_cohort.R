...
{ # Setup
  ...
  { # Load the Required CLIF Tables
    ...
    tables <- c("patient", "hospitalization", "vitals", "labs", 
                ...
                "dialysis", "intake_output", "ecmo_mcs", "patient_procedures", 
  ...
  { # Load and define outliers and global variables
    
    cat("Load the outlier thresholds\n")
...
{ # Create hospital blocks and merge
  ...
  { # Create hospital blocks
    ...
    cat("     > Saving hospital information as data table\n")
    ...
    cat("     > Flagging hospitalizations that are new blocks\n")
    ...
    cat("     > Grouping hospitals from one block together\n")
    ...
    cat("     > Creating hospital block key\n")
...
{ # Create ED blocks
  ...
  cat("     > Merging ED blocks together\n")
  # Summarize
...
{ # Applying inclusion and exclusion criteria
  cat("Applying inclusion and exclusion criteria\n")
  { # Inclusion Criteria: NIV started in ED
    cat("     > Inclusion Criteria: NIV started in ED\n")
  ...
  { # Inclusion Criteria: NIV must last for at least STABILITY_WINDOW_MINS with a maximum of MAX_NIV_BREAK_MINS not on NIV
    cat("     > Inclusion Criteria: NIV must last for at least STABILITY_WINDOW_MINS with a maximum of MAX_NIV_BREAK_MINS not on NIV\n")
  ...
  { # Inclusion Criteria: Admitted to Ward, IMC, or ICU within the same hospital system
    ...
    cat("     > Inclusion Criteria: Admitted to Ward, IMC, or ICU within the same hospital system\n")
    final_cohort <- final_cohort |>
  ...
  { # Exclusion Criteria: Patient still admitted
    cat("     > Exclusion Criteria: Patient still admitted\n")
    final_cohort <- final_cohort |>
  ...
  { # Exclusion Criteria: Code status allow natural death time exiting ED
    ...
    cat("     > Exclusion Criteria: Code status allow natural death time exiting ED\n")
  ...
  { # Exclusion Criteria: Any IMV or tracheostomy in the ED
    ...
    cat("     > Exclusion Criteria: Any IMV or tracheostomy in the ED\n")
  ...
  { # Exclusion Criteria: Any continuous pressors in the ED
    ...
    cat("     > Exclusion Criteria: Any continuous pressors in the ED\n")
  ...
  { # Exclusion Criteria: Any CRRT in ED
    ...
    cat("     > Exclusion Criteria: Any CRRT in the ED\n")
  ...
  { # Exclusion Criteria: Admitted to IMC at IMC-incapable hospital
    ...
    cat("     > Exclusion Criteria: Admitted to IMC at IMC-incapable hospital\n")
