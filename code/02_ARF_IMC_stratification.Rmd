...
# Study start and end
STUDY_START <- as.POSIXct(gobal_config$study_start, tz=site_time_zone) # Start time
STUDY_END <- as.POSIXct(gobal_config$study_end, tz=site_time_zone) # End time

# Device names that are included as NIV
NIV_NAMES <- gobal_config$niv_devices 
# Device names that would be considered "off NIV"
NIV_FREE_NAMES <- gobal_config$niv_free_devices
