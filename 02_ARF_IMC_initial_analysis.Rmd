---
title: "02_ARF_IMC_initial_analysis"
...
create_tab_1 <- function(df, include_imc_avail){
  ...
  tab_1_continuous <- cbind(summarize_continuous(df, "age_at_admission", "age", T),
  ...
  # Create single table for all variables
  tab_1_catagorical <- cbind(summarize_categorical(df, "race_summary", nickname = "race", include_titles = TRUE),
...
create_tab_2 <- function(df, include_imc_avail){
  ...
  tab_2 <- df |>
    ...
    tbl_summary(
      ...
      label = list(
        ...
        days_off ~ "NIV-free days over the first 28 days from starting NIV, days, mean (SD)",
  ...
  # Create single table for all variables
  tab_2_continuous <- cbind(summarize_continuous(df, "los_penalized", "los", T),
  ...
  # Create single table for all variables
  tab_2_catagorical <- cbind(summarize_categorical(df, "death_hospice", nickname = "dh", include_titles = TRUE),
